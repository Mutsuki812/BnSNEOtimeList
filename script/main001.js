...
renderEventBlock = function() {
  ...
  bellButton.innerHTML = `<img src="images/bell-${settings.enabled ? 'on' : 'off'}.svg" alt="通知">`;
...
function saveNotificationConfig() {
  ...
  if (button) {
    button.innerHTML = `<img src="images/bell-${settings.enabled ? 'on' : 'off'}.svg" alt="通知">`;
  }
...
function clearNotificationConfig() {
  ...
  const button = document.getElementById('bellButton');
  if (button) {
    button.innerHTML = `<img src="images/bell-off.svg" alt="通知">`;
  }
